...
@section('content')
    ...
    <div style="background-image:url('/image/profile-header-img.jpg');width:850px;height:80px;margin-bottom:10px;">
        <span style="background-color: #eaeaea;color: #5f5f5f;padding: 0px 10px 0px 10px;margin: 25px 26px 0 0;float: right;font-size: 20px;">
            <i class="fa  fa-mail-forward" style="font-size: 14px;margin-left:3px;vertical-align: middle"></i>پیام های ارسالی
        </span>
    </div>
        ...
        <table class="table table-bordered">
            ...
            @foreach($asks as $ask)
                <tr>
                    ...
                    <td>
                        <a href="{{route('ask_user.show',['id'=>$ask->id])}}" class="btn btn-info btn-xs"> جزئیات تیکت </a>
                    </td>
                </tr>
            @endforeach
            </tbody>
