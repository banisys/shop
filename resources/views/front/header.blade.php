        ...
        <nav id="top" class="htop" style="background-color: #1f1f1f;">
            <div class="container">
                <div class="row"><span class="drop-icon visible-sm visible-xs"><i
                                class="fa fa-align-justify" style="color:#eaeaea"></i></span>
                                ...
                                @if (Route::has('login'))
                                    ...
                                    @else
                                        <li style="margin-top:-5px;">
                                            <a style="font-size: 15px;" href="{{ route('login') }}">ورود</a>
                                        </li>

                                        <li style="margin-top:-5px;margin-right: 8px">
                                            <a style="font-size: 15px;" href="{{ route('register') }}">ثبت نام</a>
                                        </li>
                                    @endauth
                                @endif
                            </ul>
        ...
        <header class="header-row">
            <div class="container">
                <div class="table-container">
                    <div class="col-table-cell col-lg-12 col-md-12 col-md-push-0 col-sm-6 col-sm-push-6 col-xs-12">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <p class="checkout"><a href="{{route('cart.index')}}"
